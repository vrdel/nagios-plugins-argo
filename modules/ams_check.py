...
def main():
    ...
    parser.add_argument('-H', type=str, default='messaging-devel.argo.grnet.gr', help='FQDN of AMS Service')
    ...
    parser.add_argument('-t', type=int, default=TIMEOUT, help='Timeout')
