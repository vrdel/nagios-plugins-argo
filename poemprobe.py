...
#za ovaj prebrojati sve razlicite metric name-ove
#http://poem-devel.argo.grnet.gr/poem/api/0.2/json/metrics_in_profiles?vo_name=ops


#za ovaj prebrojati sve razlicite service type-ove
#http://poem-devel.argo.grnet.gr/poem/api/0.2/json/profiles/

#npr. profile_name="ROC_OPERATORS"
